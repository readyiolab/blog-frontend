...
const ArticleSidebar = lazy(() => import("@/components/ArticleSidebar"));
const AuthorBox = lazy(() => import("@/components/AuthorBox"));
      ...
      <div className="mx-auto max-w-7xl px-4 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[80px_1fr_320px] gap-10">
          ...
          <article className="min-w-0">
            ...
            {/* Comments Section */}
            <Suspense fallback={<div className="mt-8 h-64 w-full animate-pulse rounded-xl bg-muted" />}>
